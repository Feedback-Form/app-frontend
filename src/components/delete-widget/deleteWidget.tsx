...
import { DeleteWidgetProps } from './deleteWidgetInterface';
const DeleteWidget = ({ closeWidgetHandlerFunction, deleteHandlerFunction, itemName }: DeleteWidgetProps): ReactElement => {
	return (
				...
				<div className="flex justify-center h-full w-full items-center">
					<div className="w-3/4 md:w-1/3 xl:w-1/4 bg-white rounded-md px-10 py-8 space-y-6">
						<div className="space-y-2">
							<h1 className="tracking-wide font-semibold text-xl text-gray-900">Delete &quot;{itemName}&quot;?</h1>
